...
@section('content')
    <div class="container mt-5">
        <h1 class="mb-4">Moteur entraînement rouleaux age 2</h1>
        
        <!-- Search Form -->
        <form action="{{ route('searchp2') }}" method="GET" class="mb-3">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('deleteExcel2') }}" method="POST" id="deleteExcelForm">
                        @csrf
