...
@section('content')
    <div class="container mt-5">
        <h1 class="mb-4"> Moteur Entraînement mât </h1>
        
        <!-- Search Form -->
        <form action="{{ route('searchp12') }}" method="GET" class="mb-3">
        ...
        @if(Auth::user()->role == 'admin')
            <div class="mb-3">
                <form action="{{ route('importExcel12') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('deleteExcel12') }}" method="POST" id="deleteExcelForm">
                        @csrf
