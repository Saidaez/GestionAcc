...
@section('content')
    <div class="container mt-5">
        <h1 class="mb-4"> Index base porteuse sur caisse</h1>
        
        <!-- Search Form -->
        <form action="{{ route('searchp8') }}" method="GET" class="mb-3">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('deleteExcel8') }}" method="POST" id="deleteExcelForm">
                        @csrf
